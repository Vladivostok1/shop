...
let productData = () => {
    ...
    for (let i = 0; i < 30; i++) {
        let product = {
            ...
            img: Random.dataImage('125x125','农机'+Random.integer(10,100)),
            price: Random.integer(50000, 110000),
            owner: Random.cname()
        }
...
Mock.mock('http://www.weichuang.com/getList', productData);
